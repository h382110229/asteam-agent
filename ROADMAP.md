...
| **v1.2.1** | 2026-03 | 浏览器外置打开、资源管理器定位、交付制品货架、慢思考提拔固化 | 🔄 规划执行中 |
| **v1.3.0** | 2026-04 | 存储路径自定义(脱离C盘)、Memory 记忆中心、多 LLM 接入池容灾 | 📅 即将启动 |
